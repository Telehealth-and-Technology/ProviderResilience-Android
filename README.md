...
*Provider Resilience aims to reduce burnout and stress in behavioral health providers*  
...
## Getting Started
Provider Resilience should follow the [standard android app build process.](https://developer.android.com/studio/build/index.html) You will, however, need the T2 encryption library module (see below). 
...
## Known Issues
There are no kown issues with the application at this time. Current plans to update the application are scheduled for FY 17.
